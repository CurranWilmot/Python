...
shirley.make_deposit(100000)
shirley.make_withdrawal(50000)
shirley.make_withdrawal(10000)
shirley.make_withdrawal(30000)
shirley.display_user_balance()

# Transfers 4000 from one user to another

monty.transfer_money(shirley, 4000)

# Displays new balances
